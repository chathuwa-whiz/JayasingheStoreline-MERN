...
export function InquiryHeader() {
  ...
  return (
    <>
    <div className="h-16 bg-white flex items-center justify-between px-4">
      <h1 className="text-xl font-bold">Order Inquiries</h1>
...
export function OrdersByProducts() {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const dropdownRef = useRef(null);
...
export function OrderReportsHeader( { onExportToExcel } ) {
  return (
    <div className="h-16 bg-white flex justify-between items-center px-4">
