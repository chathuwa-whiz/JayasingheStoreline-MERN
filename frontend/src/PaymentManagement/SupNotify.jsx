...
function SupplierNotify() {
  // Dummy data for supplier notifications
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'New Shipment', message: 'Supplier X has shipped new products.', status: 'Pending', date: '2024-08-23' },
    { id: 2, title: 'Invoice Received', message: 'Invoice from Supplier Y received.', status: 'Accepted', date: '2024-08-22' },
  ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <h1 className="text-3xl font-bold mb-6">Supplier Notifications</h1>
