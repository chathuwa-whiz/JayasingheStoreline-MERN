          ...
          <ul>
            ...
            <li className='mb-4'>
              <button
                ...
                className="flex items-center text-black hover:bg-orange-600 hover:text-white rounded-lg px-4 py-3 w-full text-left transition-colors duration-300"
              >
                <FaTruck className="h-6 w-6 mr-4" />
                Deliveries
              </button>
              {isDeliveryOpen && (
                <ul className="ml-4 mt-2 space-y-1 bg-gray-100 rounded-lg">
                  <li>
                    <NavLink
                      to="deliverydetail"
                      className="flex items-center text-black hover:bg-orange-500 hover:text-white rounded-lg px-4 py-2 transition-colors duration-300"
                    >
        ...
        <nav>
          <ul>
            ...
            <li className="mb-4">
              <NavLink
                to="logout"
                className="flex items-center text-black hover:bg-red-600 hover:text-white rounded-lg px-4 py-3 transition-colors duration-300"
              >
